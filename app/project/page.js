...
function ProjectCard({title, image, slug}) {
    return(
        <Link href={`/project/${slug}`}>
            <div className="flex items-center overflow-hidden rounded-xl lg:w-[40rem] w-full bg-[#091230] shadow-md shadow-primary-blue/75 transition-all lg:hover:shadow-lg lg:hover:scale-[1.03] lg:hover:shadow-primary-blue">
        ...
        <>
            ...
            <div className=" max-w-screen min-h-fit bg-[#0a0c21] mb-32">
                <div className="mx-auto h-full flex flex-col justify-center items-center">
                    ...
                    <div className="container w-100 flex flex-col justify-center items-center transition-all gap-8 lg:w-full lg:gap-4 my-4 p-4">
